...
$pageTitle = 'Master Lokasi Gudang';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || $code === '') {
        $error = 'Nama dan kode gudang wajib diisi.';
    } else {
        if ($id > 0) {
            // update
            ...
            try {
                ...
                if (strpos($e->getMessage(), 'uq_warehouses_code') !== false) {
                    $error = 'Kode gudang sudah digunakan. Pilih kode lain.';
                } else {
                    throw $e;
                }
            }
...
if (isset($_GET['delete'])) {
    ...
    if ($delId > 0) {
        ...
        if ($cek->fetchColumn() > 0) {
            $error = 'Gudang ini sudah dipakai di transaksi dan tidak bisa dihapus.';
        } else {
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold text-dark mb-1">Master Gudang</h4>
        ...
        <div class="card card-modern h-100">
            ...
            <div class="card-body">
                ...
                <form method="post" autocomplete="off">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted">Kode Gudang (Unik)</label>
                        <div class="input-group form-icon-group">
                        ...
                        <div class="form-text small text-end fst-italic">Kode tidak boleh sama dengan gudang lain.</div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group form-icon-group">
                            ...
                            <textarea name="description" class="form-control" rows="3" placeholder="Keterangan lokasi atau detail gudang..."><?= htmlspecialchars($editData['description'] ?? ''); ?></textarea>
                        </div>
                    </div>
                        ...
                        <?php if (empty($warehouses)): ?>
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    ...
                                    <div class="text-muted fw-bold">Belum ada data gudang</div>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="master_gudang.php?delete=<?= (int)$g['id']; ?>"
                                               ...
                                               onclick="return confirm('Yakin ingin menghapus gudang <?= htmlspecialchars($g['name']); ?>?');"
