...
function getCompanyHeader($warehouseName)
{
    ...
    $default = [
        ...
        'form_number' => '-',                       // <-- default nomor form
    ];
    ...
    $map = [
        'PT. Dua Naga Kosmetindo' => [
            ...
            'web'         => '',
            'city_line'   => 'Sukoharjo',
            'form_number' => 'DNK-FORM-PD-04-02',   // <-- sesuai permintaan
        ],
        'CV. Zweena Adi Nugraha' => [
            ...
            'city_line'   => 'Sukoharjo',
            'form_number' => 'WH/FORM/013/01',      // <-- sesuai permintaan
        ],
        ...
        <tr>
            ...
            <td class="header-info-cell">
                <table class="mini-info">
                    ...
                    <tr>
                        <td>Nomor</td>
                        <!-- DI SINI DIGANTI: pakai nomor form dari mapping perusahaan -->
